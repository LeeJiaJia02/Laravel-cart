...
Route::post('/update-to-cart/{id}','App\Http\Controllers\CartController@updateToCart')->name('update.to.cart');
Route::get('/delete-from-cart/{id}','App\Http\Controllers\CartController@deleteFromCart')->name('delete.from.cart');
